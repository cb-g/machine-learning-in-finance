...
The neural network architecture is adapted from and closely follows [this Turing.jl tutorial](https://turing.ml/dev/tutorials/03-bayesian-neural-network/#generic-bayesian-neural-networks).
